...
class TestAuthBlueprint(BaseTestCase):
    ...
    def test_registered_with_already_registered_client(self):
    ...
    def test_registered_client_login(self):
        ...
        with self.client:
            # client registration
            resp_register = register_client(self)
